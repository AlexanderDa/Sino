...
grant all on sequence asignatura_curso_id_seq   to admin;
...
GRANT all ON table asignatura_curso     to Admin;
...
grant all on sequence asignatura_curso_id_seq   to profesor;
...
GRANT all ON table asignatura_curso     to profesor;
